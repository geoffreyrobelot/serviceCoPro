...
public class Cryptage {
	...
	public static void main(String[] args) throws Exception {
		...
		// default parameters
		int keyLength = 128;
		SecretKeySpec key = createSecretKey(salt, iterationCount, keyLength);
	...
	public static SecretKeySpec createSecretKey(byte[] salt, int iterationCount, int keyLength) throws NoSuchAlgorithmException, InvalidKeySpecException {
		SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA512");
		PBEKeySpec keySpec = new PBEKeySpec(null, salt, iterationCount, keyLength);
