...
import model.ReservationserviceEjb;

@Path("reservation")
public class ServiceReservationService {

	@EJB
	ReservationserviceEjb reservationServiceEjb;
	...
	public Collection<Reservationservice> lireToutesLesReservationsServiceJson() {
		Collection<Reservationservice> col = reservationServiceEjb.getReservationServiceFindAll();
		return col;
	}
